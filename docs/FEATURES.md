...
- **Doc**: [ADVENTURES.md](ADVENTURES.md)
...
- **Status**: Implemented
- **Doc**: [STATISTICS.md](STATISTICS.md)
...
- **Doc**: [EXERCISE_COLORS.md](EXERCISE_COLORS.md)
...
| [QUESTS.md](QUESTS.md) | Quest (workout) system |
...
| [STATISTICS.md](STATISTICS.md) | Stats & progress tracking |
| [EXERCISE_COLORS.md](EXERCISE_COLORS.md) | Color system |
| [UI_GUIDE.md](UI_GUIDE.md) | Visual design system |
| [ARCHITECTURE.md](ARCHITECTURE.md) | Technical architecture |
| [FUTURE.md](FUTURE.md) | Future roadmap |
