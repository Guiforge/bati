...
export const achievementDefinitions: AchievementDefinition[] = [
  ...
  // Streak milestones
  {
    ...
    enDescription: "Achieve a 3-day streak",
    frDescription: "Atteins une série de 3 jours",
    category: "streaks",
  },
  {
    code: "streak_7",
    ...
    enDescription: "Achieve a 7-day streak",
    frDescription: "Atteins une série de 7 jours",
    category: "streaks",
  },
  {
    code: "streak_14",
    ...
    enDescription: "Achieve a 14-day streak",
    frDescription: "Atteins une série de 14 jours",
    category: "streaks",
  },
  {
    code: "streak_30",
    ...
    enDescription: "Achieve a 30-day streak",
    frDescription: "Atteins une série de 30 jours",
    category: "streaks",
  },
  {
    code: "streak_60",
    ...
    enTitle: "Unstoppable",
    frTitle: "Inarrêtable",
    enDescription: "Achieve a 60-day streak",
    frDescription: "Atteins une série de 60 jours",
    category: "streaks",
  },
  {
    code: "streak_100",
    ...
    enTitle: "Centurion",
    frTitle: "Centurion",
    enDescription: "Achieve a 100-day streak",
    frDescription: "Atteins une série de 100 jours",
    category: "streaks",
  },
