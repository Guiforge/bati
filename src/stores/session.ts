...
import { checkForNewAchievements, type NewAchievementResult } from "@/src/db/achievements";
import {
  type BossFight,
  type DamageResult,
  dealDamage,
  ...
  subscribeWithSelector((set, get) => ({
    ...
    finishCountdown: () => {
      ...
      set({
        ...
        timerDuration: isTimeBased ? 0 : 0, // No countdown for time-based, just chrono
      });
    },
