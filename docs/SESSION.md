# Session Flow (Active Workout UI)

## Overview

The Session is the core experience — where the actual workout happens. It must be **sport-focused first**, with RPG elements enhancing (not distracting from) the workout.
