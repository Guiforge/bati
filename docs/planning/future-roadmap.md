...
status: speculative
updated: 2026-07-18
related: [roadmap-alignment.md]
---

# Future Roadmap

> ⚠️ **Speculative, pre-alignment.** Written before the 2026-07 vision realignment. Where it
> conflicts with [roadmap-alignment.md](roadmap-alignment.md) (e.g. Gold/economy timing,
> village rendering approach), **roadmap-alignment.md wins**. Kept for later-phase ideas not
> yet re-validated against the source-of-truth product wiki.
