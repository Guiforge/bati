...
> = {
  overtraining: {
    en: [
      ...
      "That's {{count}} sessions this week — your body earns its rest same as its gains.",
  ...
  high_volume: {
    en: [
      ...
      "{{count}} workouts this week — that's serious volume. Recovery is where the strength actually builds.",
    ...
    fr: [
      ...
      "{{count}} entraînements cette semaine — un sacré volume. C'est pendant la récup que la force se construit vraiment.",
      "{{count}} séances en sept jours. Laisse ton corps rattraper ton ambition, une journée.",
    ],
  },
  deload: {
    en: [
      "Four hard weeks in a row. Take an easier one — less volume, not less training. Your next month starts here.",
    ...
    fr: [
      "Quatre semaines chargées d'affilée. Prends-en une plus légère — moins de volume, pas moins d'entraînement. Ton prochain mois commence là.",
      "Un mois de semaines chargées derrière toi. Lève un peu le pied quelques jours — les gains rattrapent pendant que tu récupères.",
