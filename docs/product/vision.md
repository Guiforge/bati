...
- 🏋️ **Sport First** — The workout is the core
- 🎮 **Fun Rewards** — RPG elements enhance motivation
- 📴 **Offline-First** — Works anywhere
- ⚡ **Simple** — Minimal choices, maximum engagement
...
```text
Train → Earn Rewards → Village Grows → Repeat
```
...
| ------ | -------------- |
| Level | Village tier (12 stages, hameau → capitale éternelle) |
...
Daily workouts fuel your Sacred Flame:

- 7 days → Ember 🔥
- 30 days → Inferno 🔥🔥🔥
- Miss a day? Flame dims, but doesn't die
