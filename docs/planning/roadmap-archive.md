...
# Bati - Complete Roadmap & TODO (Archive)

> ⚠️ **Archived.** This is a historical record of what was built, useful to know *what to
> clean up*. **[roadmap-alignment.md](roadmap-alignment.md) is the current source of truth**
> for prioritization and MVP scope — it supersedes this document.
