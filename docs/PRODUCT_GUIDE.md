...
- [Onboarding](./pages/onboarding.md) → [Home](./pages/home.md)

Daily training paths:

- [Home](./pages/home.md) → [Quests Gallery](./pages/quests.md) → [Quest Details](./pages/quest-details.md) → [Session](./pages/session.md) → [Journal](./pages/journal.md)
- [Home](./pages/home.md) → [Adventures Gallery](./pages/adventures.md) → [Adventure Details](./pages/adventure-details.md) → [Quest Details](./pages/quest-details.md) → [Session](./pages/session.md)

Progress & rewards:

- [Home](./pages/home.md) → [Village](./pages/village.md)
- [Home](./pages/home.md) → [Treasury](./pages/treasury.md)
- [Journal](./pages/journal.md) → [Session Details](./pages/session-details.md)

Planning:

- [Home](./pages/home.md) → [Goals](./pages/goals.md) → [Schedule](./pages/schedule.md)

Preferences:

- [Home](./pages/home.md) → [Settings](./pages/settings.md)

### Features by page (quick reference)

- **[Onboarding](./pages/onboarding.md)** → first-time setup: language, avatar, village name.
- **[Home](./pages/home.md)** → continue adventure, quick links, progress snapshot.
- **[Quests Gallery](./pages/quests.md)** → browse workouts, narrow choices, pick a quest.
- **[Quest Details](./pages/quest-details.md)** → understand the workout, choose difficulty, start.
- **[Adventures Gallery](./pages/adventures.md)** → browse campaigns (route/boss/event).
- **[Adventure Details](./pages/adventure-details.md)** → see steps, progress, start/continue next quest.
- **[Session](./pages/session.md)** → do the workout, rest/pause, finish and earn rewards.
- **[Journal](./pages/journal.md)** → stats + history, open past sessions.
- **[Session Details](./pages/session-details.md)** → per-session report (your “receipt”).
- **[Village](./pages/village.md)** → visual progress from training.
- **[Treasury](./pages/treasury.md)** → loot totals (gold + resources).
- **[Goals](./pages/goals.md)** → set direction (focus/frequency/duration).
- **[Schedule](./pages/schedule.md)** → weekly view + rest suggestion.
- **[Settings](./pages/settings.md)** → language and preferences.
- **[Credits](./pages/credits.md)** → acknowledgements.
